...
//function createDatepicker() {	// for datepicker
...
////					'<a class="sidebar-close" href="#"><img src="img/icons/close-icon.svg" alt=""></a>' +
////				'</div>' +
////				'<div class="sidebar-body">' +
////					'<h6 class="theme-title">Choose Mode</h6>' +
////					'<div class="switch-wrapper">' +
////						'<div id="dark-mode-toggle">' +
////							'<span class="light-mode active"> <img src="img/icons/sun-icon.svg" class="me-2" alt=""> Light</span>' +
...
////									'<img class="img-fliud" src="img/layout-ltr.png" alt="layout">' +
////								'</div>' +
////							'</div>' +
////						'</div>' +
////						'<div class="col-xl-6 ere">' +
...
////								'</div>' +
////								'<div class="layout-img">' +
////									'<img class="img-fliud" src="img/layout-rtl.png" alt="layout">' +
////								'</div>' +
////							'</div>' +
////						'</div>' +
////					'</div>' +
...
////								'</div>' +
////								'<div class="layout-img">' +
////									'<img class="img-fliud" src="img/layout-04.png" alt="layout">' +
////								'</div>' +
////							'</div>' +
////						'</div>' +
////						'<div class="col-xl-6 ere">' +
...
////								'</div>' +
////							 	'<div class="layout-img">' +
////									 '<img class="img-fliud" src="img/layout-01.png" alt="layout">' +
////							 	'</div>' +
////						 	'</div>' +
////						'</div>' +
////					'</div>' +
...
////								'</div>' +
////								'<div class="layout-img">' +
////									'<img class="img-fliud" src="img/layout-03.png" alt="layout">' +
////								'</div>' +
////							'</div>' +
////						'</div>' +
////						'<div class="col-xl-6 ere">' +
